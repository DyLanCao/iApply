...
* Return         : None
*******************************************************************************/
void RTC_CounterConfig (uint32_t CounterValue)
{
...
/* Update the RTC counter register with the new time and date */
  ...
  RTC->CNTL = (uint16_t)CounterValue;
...
* Return         : None
*******************************************************************************/
void RTC_PrescalerConfig (uint32_t Xprescaler)
{
...
* Return         : None
*******************************************************************************/
void RTC_AlarmConfig (uint32_t Xalarm)
{
  // Wait For Last Task Completion
  RTC_WaitForLastTask ();
  // Enter In Configuration Mode
