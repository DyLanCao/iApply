...
* Return         : None.
*******************************************************************************/
void BSPI_TrFifoDepth(BSPI_TypeDef *BSPIx, uint8_t TDepth)
{
...
* Return         : None.
*******************************************************************************/
void BSPI_RcFifoDepth(BSPI_TypeDef *BSPIx, uint8_t RDepth)
{
...
* Return         : None.
*******************************************************************************/
void  BSPI_BufferSend(BSPI_TypeDef *BSPIx, uint8_t *PtrToBuffer, uint8_t NbOfWords)
{
  volatile uint8_t SendWord = 0;
...
* Return         : None.
*******************************************************************************/
void BSPI_BufferReceive(BSPI_TypeDef *BSPIx, uint8_t *PtrToBuffer, uint8_t NbOfWords)
{
  volatile uint16_t ReceiveWord = 0;
