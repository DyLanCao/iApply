...
* Return         : None
*******************************************************************************/
void FLASH_WordWrite(uint32_t XtargetAdd, uint32_t Xdata)
{
...
* Return         : None
*******************************************************************************/
void FLASH_DWordWrite(uint32_t XtargetAdd, uint32_t Xdata0, uint32_t Xdata1)
{
...
* Return         : None
*******************************************************************************/
void FLASH_SectorErase(uint32_t Xsectors)
{
  FLASH_WaitForLastTask();
...
* Return         : None
*******************************************************************************/
void FLASH_Resume(uint32_t FLASH_LastOperation)
{
...
* Return         : Word
*******************************************************************************/
uint32_t FLASH_WordRead(uint32_t FLASH_SourceAdd)
{
  FLASH_WaitForLastTask();
  // Reads the data from the specified Address
  return *(uint32_t *)(FLASH_SourceAdd + 0x40000000);
}
/*******************************************************************************
...
* Return         : None
*******************************************************************************/
void FLASH_WritePrConfig(uint32_t Xsectors, FunctionalState NewState)
{
  FLASH_WaitForLastTask();
...
{
  uint16_t ProtectionLevel = FLASH_ProtectionLevel();
...
*******************************************************************************/
uint16_t FLASH_ProtectionLevel(void)
{
  uint16_t TmpBitIndex =0;
