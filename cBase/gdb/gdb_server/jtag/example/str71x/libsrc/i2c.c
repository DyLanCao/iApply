...
* Return         : None.
*******************************************************************************/
void I2C_SpeedConfig (I2C_TypeDef *I2Cx, uint32_t Clock)
{
  uint32_t FCLK;
  uint16_t result = 0;
...
* Return         : None.
*******************************************************************************/
void I2C_AddressConfig (I2C_TypeDef *I2Cx, uint16_t Address, I2C_Addressing Mode)
{
  //Update OAR1 bit[7:1] by the lowest byte of address
  I2Cx->OAR1 = (uint8_t)Address;
...
* Return         : None.
********************************************************************************/
void I2C_AddressSend (I2C_TypeDef *I2Cx, uint16_t Address, I2C_Addressing Mode, I2C_Direction Direction)
{
  if (Mode == I2C_Mode10 )
...
* Return         : None.
*******************************************************************************/
void I2C_ByteSend (I2C_TypeDef *I2Cx, uint8_t Data)
{
...
*******************************************************************************/
I2C_Tx_Status I2C_BufferSend (I2C_TypeDef *I2Cx, uint8_t *PtrToBuffer, uint8_t NbOfBytes)
{
  uint8_t Interruption_Status;
  uint8_t SentBytes;
  uint8_t error = 0;
  I2C_Tx_Status I2C_TXTMP = I2C_TX_NO;
...
I2C_Tx_Status I2C_StringSend (I2C_TypeDef *I2Cx, char *PtrToString)
{
  ...
  return I2C_BufferSend (I2Cx,(uint8_t *)PtrToString,NbOfBytes);
}
...
*******************************************************************************/
uint8_t I2C_ByteReceive (I2C_TypeDef *I2Cx)
{
   //Wait till I2C_BTF bit is set
  while ((I2Cx->SR1 & 0x08)==0);
  return I2Cx->DR;
...
*******************************************************************************/
I2C_Rx_Status I2C_BufferReceive (I2C_TypeDef *I2Cx, uint8_t *PtrToBuffer, uint8_t NbOfBytes)
{
  uint8_t Interruption_Status;
  uint8_t ReceivedBytes;
  uint8_t error = 0;
  I2C_Rx_Status I2C_RXTMP = I2C_RX_NO;
