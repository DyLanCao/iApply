...
* Return         : None
*******************************************************************************/
void GPIO_Config (GPIO_TypeDef *GPIOx, uint16_t Port_Pins, GpioPinMode_TypeDef GPIO_Mode)
{
  switch (GPIO_Mode)
  {
...
* Return         : None
*******************************************************************************/
void GPIO_BitWrite(GPIO_TypeDef *GPIOx, uint8_t Port_Pin, uint8_t Port_Val)
{
...
* Return         : None
*******************************************************************************/
void GPIO_ByteWrite(GPIO_TypeDef *GPIOx, uint8_t Port_Byte, uint8_t Port_Val)
{
  GPIOx->PD = Port_Byte ? (GPIOx->PD&0x00FF) | ((uint16_t)Port_Val<<8)
