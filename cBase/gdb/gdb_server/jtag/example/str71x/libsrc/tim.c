...
{
  uint16_t Tmp1 = 0x0000;
  uint16_t Tmp2 = TIMx->CR2;
...
* Input          : (1) TIM Timer
* Output         : PWMI_parameters : - uint16_t Dyty cycle
                                     - uint16_t Full period
*******************************************************************************/
