...
* Return         : None.
*******************************************************************************/
extern void I2C_OnOffConfig (I2C_TypeDef *I2Cx, FunctionalState NewState);
...
* Return         : None.
*******************************************************************************/
static inline void I2C_GeneralCallConfig (I2C_TypeDef *I2Cx, FunctionalState NewState);
static inline void I2C_GeneralCallConfig (I2C_TypeDef *I2Cx, FunctionalState NewState)
{
...
* Return         : None.
*******************************************************************************/
static inline void I2C_STARTGenerate (I2C_TypeDef *I2Cx, FunctionalState NewState);
static inline void I2C_STARTGenerate (I2C_TypeDef *I2Cx, FunctionalState NewState)
{
...
* Return         : None.
*******************************************************************************/
static inline void I2C_STOPGenerate (I2C_TypeDef *I2Cx, FunctionalState NewState);
static inline void I2C_STOPGenerate (I2C_TypeDef *I2Cx, FunctionalState NewState)
{
...
* Return         : None.
*******************************************************************************/
static inline void I2C_AcknowledgeConfig (I2C_TypeDef *I2Cx, FunctionalState NewState);
static inline void I2C_AcknowledgeConfig (I2C_TypeDef *I2Cx, FunctionalState NewState)
{
...
* Return         : None.
*******************************************************************************/
static inline void I2C_ITConfig (I2C_TypeDef *I2Cx, FunctionalState NewState);
static inline void I2C_ITConfig (I2C_TypeDef *I2Cx, FunctionalState NewState)
{
...
*                                    FLASH_WriteOpStatus            I2COAR1,I2COAR2,I2CDR,I2CECCR)
* Return         : the value of the register passed as parameter(uint8_t)
*******************************************************************************/
static inline uint8_t I2C_RegisterRead (I2C_TypeDef *I2Cx, I2C_Registers reg);
static inline uint8_t I2C_RegisterRead (I2C_TypeDef *I2Cx, I2C_Registers reg)
{
  return (*((uint32_t *) ((uint32_t)I2Cx + (uint32_t)reg))) & 0xFF;
}
...
*                  input 4: an (uint8_t) variable needed in the case
*                                     of the INDIRECT access
* Return         : the NewState of the Flag (SET or RESET).
*******************************************************************************/
extern FlagStatus I2C_FlagStatus (I2C_TypeDef *I2Cx, RegisterAccess Access, I2C_Flags Flag,...);
...
* Input          : I2Cx ( I2C0 or I2C1 )
*                  Flag : the flag to be read
*                  input3: an (uint8_t) parameter needed in the case that the flag
*                         to be cleared need a write in one register
* Return         : None.
*******************************************************************************/
extern void I2C_FlagClear (I2C_TypeDef *I2Cx, I2C_Flags Flag,...);
...
* Return         : None.
*******************************************************************************/
extern void I2C_SpeedConfig (I2C_TypeDef *I2Cx, uint32_t Clock);

/*******************************************************************************
* Function Name  : I2C_AddressConfig
* Description    : Defines the I2C bus address of the interface.
* Input          : I2Cx ( I2C0 or I2C1 ).
*                  Address: an uint16_t parameter indicating the address
*                           of the interface.
*                  Mode (I2C_Mode10,I2C_Mode7).
* Return         : None.
*******************************************************************************/
extern void I2C_AddressConfig (I2C_TypeDef *I2Cx, uint16_t Address, I2C_Addressing Mode);
...
* Return         : None.
*******************************************************************************/
extern void I2C_FCLKConfig (I2C_TypeDef *I2Cx);

/*******************************************************************************
* Function Name  : I2C_AddressSend
* Description    : Transmits the address byte to select the slave device.
* Input          : I2Cx ( I2C0 or I2C1 )
*                  Address: an uint16_t parameter indicating the slave address
*                  Mode (I2C_Mode10,I2C_Mode7).
*                  Direction (I2C_RX,I2C_TX).
* Return         : None.
********************************************************************************/
extern void I2C_AddressSend (I2C_TypeDef *I2Cx, uint16_t Address, I2C_Addressing Mode, I2C_Direction Direction);
...
* Return         : None.
*******************************************************************************/
extern void I2C_ByteSend (I2C_TypeDef *I2Cx, uint8_t Data);
...
*******************************************************************************/
extern I2C_Tx_Status I2C_BufferSend (I2C_TypeDef *I2Cx, uint8_t *PtrToBuffer, uint8_t NbOfBytes);
...
*                  I2C_TX_BERR,I2C_TX_DATA_OK)
*******************************************************************************/
extern I2C_Tx_Status I2C_StringSend (I2C_TypeDef *I2Cx, char *PtrToString);
...
*******************************************************************************/
extern I2C_Tx_Status I2C_TransmissionStatus (I2C_TypeDef *I2Cx);
...
*******************************************************************************/
extern uint8_t I2C_ByteReceive (I2C_TypeDef *I2Cx);
...
*******************************************************************************/
extern I2C_Rx_Status I2C_BufferReceive (I2C_TypeDef *I2Cx, uint8_t *PtrToBuffer, uint8_t NbOfBytes);
...
*******************************************************************************/
extern I2C_Rx_Status I2C_ReceptionStatus (I2C_TypeDef *I2Cx);
...
* Return         : None.
*******************************************************************************/
static inline void I2C_ErrorClear (I2C_TypeDef *I2Cx);
static inline void I2C_ErrorClear (I2C_TypeDef *I2Cx)
{
...
*******************************************************************************/
static inline uint32_t I2C_GetStatus(I2C_TypeDef *I2Cx);
static inline uint32_t I2C_GetStatus(I2C_TypeDef *I2Cx)
{
