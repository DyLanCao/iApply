...
* Return         : None
*******************************************************************************/
extern void PCU_VRConfig ( PCU_VR xVR, FunctionalState NewState );
...
* Return         : None
*******************************************************************************/
extern void PCU_WFIEnter ( WFI_CLOCKS Xclock, FunctionalState Xlpr, FunctionalState Xlpm );
...
* Return         : None
*******************************************************************************/
extern void PCU_LPMEnter ( LPM_MODES Xmode);
