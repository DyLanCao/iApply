...
* Return         : None
*******************************************************************************/
static inline void EIC_FIQChannelConfig(FIQChannel_TypeDef, FunctionalState );
...
* Return         : None
*******************************************************************************/
static inline void EIC_IRQChannelPriorityConfig(IRQChannel_TypeDef IRQChannel, uint8_t Priority);
static inline void EIC_IRQChannelPriorityConfig(IRQChannel_TypeDef IRQChannel, uint8_t Priority)
{
  EIC->SIR[IRQChannel] = (EIC->SIR[IRQChannel]&0xFFFF0000) | (Priority & 0xF);
}
...
* Return         : None
*******************************************************************************/
extern void EIC_CurrentPriorityLevelConfig(uint8_t NewPriorityLevel);
...
*******************************************************************************/
static inline uint8_t EIC_CurrentPriorityLevelValue(void);
static inline uint8_t EIC_CurrentPriorityLevelValue(void)
{
  return EIC->CIPR & 0xF;
}
