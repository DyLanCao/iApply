...
*******************************************************************************/
static inline void CAN_EnterInitMode(uint8_t mask);
static inline void CAN_EnterInitMode(uint8_t mask)
{
...
*******************************************************************************/
static inline void CAN_EnterTestMode(uint8_t mask);
static inline void CAN_EnterTestMode(uint8_t mask)
{
	CAN->CR |= CAN_CR_TEST;
	CAN->TESTR |= mask;
...
*******************************************************************************/
extern void CAN_SetBitrate(uint32_t bitrate);
...
* Note           : CAN must be in initialization mode
*******************************************************************************/
extern void CAN_SetTiming(uint32_t tseg1, uint32_t tseg2, uint32_t sjw, uint32_t brp);
...
* Return         : None
*******************************************************************************/
extern void CAN_SleepRequest(uint32_t WakeupMode);
...
* Return         : None
*******************************************************************************/
extern void CAN_SetUnusedMsgObj(uint32_t msgobj);
...
* Return         : None
*******************************************************************************/
extern void CAN_SetTxMsgObj(uint32_t msgobj, uint32_t idType);
...
* Return         : None
*******************************************************************************/
extern void CAN_SetRxMsgObj(uint32_t msgobj, uint32_t idType, uint32_t idLow, uint32_t idHigh, BoolStatus singleOrFifoLast);
...
* Return         : None
*******************************************************************************/
extern void CAN_InvalidateAllMsgObj(void);
...
* Return         : None
*******************************************************************************/
extern void CAN_Init(uint8_t mask, uint32_t bitrate);
...
* Return         : None
*******************************************************************************/
extern void CAN_ReleaseMessage(uint32_t msgobj);
...
*******************************************************************************/
static inline void CAN_ReleaseTxMessage(uint32_t msgobj);
static inline void CAN_ReleaseTxMessage(uint32_t msgobj)
{
...
*******************************************************************************/
static inline void CAN_ReleaseRxMessage(uint32_t msgobj);
static inline void CAN_ReleaseRxMessage(uint32_t msgobj)
{
...
*******************************************************************************/
extern uint32_t  CAN_SendMessage(uint32_t msgobj, canmsg* pCanMsg);
...
*******************************************************************************/
extern uint32_t  CAN_ReceiveMessage(uint32_t msgobj, BoolStatus release, canmsg* pCanMsg);
...
* Return         : None
*******************************************************************************/
extern void CAN_WaitEndOfTx(void);
...
*******************************************************************************/
extern uint32_t CAN_BasicSendMessage(canmsg* pCanMsg);
...
* Note           : CAN must be in BASIC mode
*******************************************************************************/
extern uint32_t CAN_BasicReceiveMessage(canmsg* pCanMsg);
...
*******************************************************************************/
static inline uint32_t CAN_IsMessageWaiting(uint32_t msgobj);
static inline uint32_t CAN_IsMessageWaiting(uint32_t msgobj)
{
...
*                  to transmit, else 0
*******************************************************************************/
static inline uint32_t CAN_IsTransmitRequested(uint32_t msgobj);
static inline uint32_t CAN_IsTransmitRequested(uint32_t msgobj)
{
...
*                  pending, else 0
*******************************************************************************/
static inline uint32_t CAN_IsInterruptPending(uint32_t msgobj);
static inline uint32_t CAN_IsInterruptPending(uint32_t msgobj)
{
...
*                  else 0
*******************************************************************************/
static inline uint32_t CAN_IsObjectValid(uint32_t msgobj);
static inline uint32_t CAN_IsObjectValid(uint32_t msgobj)
{
