...
* Return         : None
*******************************************************************************/
static inline void XTI_ModeConfig(XTIMode_TypeDef Mode,FunctionalState NewState);
static inline void XTI_ModeConfig(XTIMode_TypeDef Mode,FunctionalState NewState)
{
...
* Return         : None
*******************************************************************************/
extern void XTI_LineModeConfig(uint16_t Lines, XTITriggerEdge_TypeDef TriggerEdge);
...
* Return         : None
*******************************************************************************/
extern void XTI_LineConfig(uint16_t Lines, FunctionalState NewState);
...
* Return         : None
*******************************************************************************/
static inline uint16_t XTI_InterruptLineValue(void);
static inline uint16_t XTI_InterruptLineValue(void)
{
  return XTI->PRL | ((uint16_t)XTI->PRH<<8);
}
...
* Return         : None
*******************************************************************************/
static inline void XTI_PendingBitClear(uint16_t Lines);
static inline void XTI_PendingBitClear(uint16_t Lines)
{
  XTI->PRL &= ~Lines;
...
* Return         : None
*******************************************************************************/
static inline void XTI_SWIRQGenerate(void);
static inline void XTI_SWIRQGenerate(void)
{
  XTI->SR = 0x01;
  XTI->SR = 0x00;
