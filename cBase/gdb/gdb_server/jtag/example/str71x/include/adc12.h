...
* Return             : None
*******************************************************************************/
static inline void ADC12_ConversionStart (void);
static inline void ADC12_ConversionStart (void)
{
...
* Return             : None.
*******************************************************************************/
static inline void ADC12_ConversionStop(void);
static inline void ADC12_ConversionStop(void)
{
...
* Return             : None
*******************************************************************************/
static inline void ADC12_ModeConfig (ADC12_Modes ConversionMode);
static inline void ADC12_ModeConfig (ADC12_Modes ConversionMode)
{
...
* Return             : None.
*******************************************************************************/
extern void ADC12_PrescalerConfig(uint32_t Adc12_clk);
...
* Return             : None
*******************************************************************************/
static inline void ADC12_ChannelSelect(ADC12_Channels ADC12_Channel);
static inline void ADC12_ChannelSelect(ADC12_Channels ADC12_Channel)
{
...
*******************************************************************************/
static inline FlagStatus ADC12_FlagStatus (ADC12_Flags flag);
static inline FlagStatus ADC12_FlagStatus (ADC12_Flags flag)
{
...
*******************************************************************************/
static inline uint16_t ADC12_ConversionValue( ADC12_Channels ADC12_Channel);
static inline uint16_t ADC12_ConversionValue( ADC12_Channels ADC12_Channel)
{
  // Clear the corespondent DA bit 
  ADC12->CSR &= ~(1<<(ADC12_Channel >> 4));
  // Only the 12 MSB of the DATAn Register are taken
  return *(uint16_t *)(ADC12_BASE + (ADC12_Channel >> 1)) >> 4;
}
...
* Return             : None
*******************************************************************************/
extern void ADC12_ITConfig (FunctionalState NewState);
