...
* Return         : None
*******************************************************************************/
extern void RCCU_PLL1Config ( RCCU_PLL1_Mul New_Mul, RCCU_PLL_Div New_Div );
...
* Return         : None
*******************************************************************************/
extern void RCCU_PLL2Config ( RCCU_PLL2_Mul New_Mul, RCCU_PLL_Div New_Div );
...
* Return         : None
*******************************************************************************/
extern void RCCU_RCLKSourceConfig ( RCCU_RCLK_Clocks New_Clock );
...
*******************************************************************************/
extern RCCU_RCLK_Clocks RCCU_RCLKClockSource ( void );
...
*******************************************************************************/
extern RCCU_USB_Clocks RCCU_USBClockSource ( void );
...
* Return         : uint32_t
*******************************************************************************/
extern uint32_t RCCU_FrequencyValue ( RCCU_Clocks Internal_Clk );
