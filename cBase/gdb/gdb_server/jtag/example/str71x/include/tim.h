...
#define TIM_OCB_IT   0x0800 // Output Capture Channel B
...
* Return         : None
*******************************************************************************/
extern void TIM_Init( TIM_TypeDef *TIMx );
...
* Return         : None
*******************************************************************************/
static inline void TIM_PrescalerConfig ( TIM_TypeDef *TIMx, uint8_t Xprescaler );
static inline void TIM_PrescalerConfig ( TIM_TypeDef *TIMx, uint8_t Xprescaler )
{
...
* Input          : TIM Timer
* Return         : Prescaler ( uint8_t )
*******************************************************************************/
static inline uint8_t TIM_PrescalerValue ( TIM_TypeDef *TIMx );
static inline uint8_t TIM_PrescalerValue ( TIM_TypeDef *TIMx )
{
...
* Output         : None
*******************************************************************************/
extern void TIM_ICAPModeConfig ( TIM_TypeDef  *TIMx,
...
* Output         : None
*******************************************************************************/
static inline uint16_t TIM_ICAPValue ( TIM_TypeDef *TIMx, TIM_Channels Xchannel );
static inline uint16_t TIM_ICAPValue ( TIM_TypeDef *TIMx, TIM_Channels Xchannel )
{
...
* Output         : None
*******************************************************************************/
extern void TIM_OCMPModeConfig (  TIM_TypeDef  *TIMx,
                           TIM_Channels Xchannel,
                           uint16_t XpulseLength,
                           TIM_OC_Modes     Xmode,
...
* Output         : None
*******************************************************************************/
extern void TIM_OPModeConfig ( TIM_TypeDef  *TIMx,
                        uint16_t XpulseLength,
...
*                : (4) Full period : u16
*                : (5) Level 2     : During the after the pulse
*                : (6) OC_Mode     : output wave, or only timing.
* Output         : None
*******************************************************************************/
extern void TIM_PWM_ModeConfig ( TIM_TypeDef  *TIMx,
                          uint16_t XDutyCycle,
                          TIM_Logic_Levels XLevel1,
                          uint16_t XFullperiod,
                          TIM_Logic_Levels XLevel2,
                          TIM_OC_Modes     Xmode
                        );
...
* Output         : None
*******************************************************************************/
extern void TIM_PWMIModeConfig ( TIM_TypeDef *TIMx, TIM_Clock_Edges Xedge );
...
* Output         : PWMI_parameters : - u16 Dyty cycle
                                     - u16 Full period
*******************************************************************************/
extern PWMI_parameters TIM_PWMIValue (TIM_TypeDef *TIMx );
...
* Output         : None
*******************************************************************************/
extern void TIM_CounterConfig ( TIM_TypeDef *TIMx, TIM_CounterOperations Xoperation );
...
* Output         : None
*******************************************************************************/
static inline void TIM_ITConfig ( TIM_TypeDef *TIMx, uint16_t New_IT, FunctionalState NewState );
static inline void TIM_ITConfig ( TIM_TypeDef *TIMx, uint16_t New_IT, FunctionalState NewState )
{
...
*******************************************************************************/
static inline uint16_t TIM_CounterValue(TIM_TypeDef *TIMx);
static inline uint16_t TIM_CounterValue(TIM_TypeDef *TIMx)
{
	return TIMx->CNTR;
}
