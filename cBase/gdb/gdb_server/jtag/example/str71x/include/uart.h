...
* Return         : None
*******************************************************************************/
extern void UART_Init(UART_TypeDef *UARTx);
...
static inline void UART_ModeConfig(UART_TypeDef *UARTx, UARTMode_TypeDef UART_Mode)
{
  UARTx->CR = (UARTx->CR&0xFFF8)|(uint16_t)UART_Mode;
}
...
* Return         : None
*******************************************************************************/
extern void UART_BaudRateConfig(UART_TypeDef *UARTx, uint32_t BaudRate);
...
static inline void UART_ParityConfig(UART_TypeDef *UARTx, UARTParity_TypeDef Parity)
{
  UARTx->CR = (UARTx->CR&0xFFDF)|(uint16_t)Parity;
}
...
static inline void UART_StopBitsConfig(UART_TypeDef *UARTx, UARTStopBits_TypeDef StopBits)
{
  UARTx->CR = (UARTx->CR&0xFFE7)|(uint16_t)StopBits;
}
...
* Return         : None
*******************************************************************************/
extern void UART_Config(UART_TypeDef *UARTx, uint32_t BaudRate, UARTParity_TypeDef Parity,
...
* Return         : None
*******************************************************************************/
extern void UART_ItConfig(UART_TypeDef *UARTx, uint16_t UART_Flag, FunctionalState NewState);
...
* Return         : None
*******************************************************************************/
extern void UART_FifoConfig(UART_TypeDef *UARTx, FunctionalState NewState);
...
* Return         : None
*******************************************************************************/
extern void UART_FifoReset(UART_TypeDef *UARTx, UARTFIFO_TypeDef FIFO);
...
* Return         : None
*******************************************************************************/
extern void UART_LoopBackConfig(UART_TypeDef *UARTx, FunctionalState NewState);
...
* Return         : None
*******************************************************************************/
static inline void UART_TimeOutPeriodConfig(UART_TypeDef *UARTx, uint16_t TimeOutPeriod);
static inline void UART_TimeOutPeriodConfig(UART_TypeDef *UARTx, uint16_t TimeOutPeriod)
{
...
* Return         : None
*******************************************************************************/
static inline void UART_GuardTimeConfig(UART_TypeDef *UARTx, uint16_t GuardTime);
static inline void UART_GuardTimeConfig(UART_TypeDef *UARTx, uint16_t GuardTime)
{
  UARTx->GTR = GuardTime;
}
...
* Return         : None
*******************************************************************************/
extern void UART_RxConfig(UART_TypeDef *UARTx, FunctionalState NewState);
...
* Return         : None
*******************************************************************************/
extern void UART_OnOffConfig(UART_TypeDef *UARTx, FunctionalState NewState);
...
* Return         : None
*******************************************************************************/
extern void UART_ByteSend(UART_TypeDef *UARTx, uint8_t *Data);
...
* Return         : None
*******************************************************************************/
extern void UART_9BitByteSend(UART_TypeDef *UARTx, uint16_t *Data);
...
* Return         : None
*******************************************************************************/
extern void UART_DataSend(UART_TypeDef *UARTx, uint8_t *Data, uint8_t DataLength);
...
* Return         : None
*******************************************************************************/
extern void UART_9BitDataSend(UART_TypeDef *UARTx, uint16_t *Data, uint8_t DataLength);
...
* Return         : None
*******************************************************************************/
extern void UART_StringSend(UART_TypeDef *UARTx, uint8_t *String);
...
*******************************************************************************/
extern uint16_t UART_ByteReceive(UART_TypeDef *UARTx, uint8_t *Data, uint8_t TimeOut);
...
* Return         : The UARTx.SR register contents
*******************************************************************************/
extern uint16_t UART_9BitByteReceive(UART_TypeDef *UARTx, uint16_t *Data, uint8_t TimeOut);
...
* Return         : The UARTx.SR register contents
*******************************************************************************/
extern uint16_t UART_DataReceive(UART_TypeDef *UARTx, uint8_t *Data, uint8_t DataLength, uint8_t TimeOut);
...
* Return         : The UARTx.SR register contents
*******************************************************************************/
extern uint16_t UART_9BitDataReceive(UART_TypeDef *UARTx, uint16_t *Data, uint8_t DataLength, uint8_t TimeOut);
...
* Return         : None
*******************************************************************************/
extern uint16_t UART_StringReceive(UART_TypeDef *UARTx, uint8_t *Data);
...
* Return         : None
*******************************************************************************/
static inline uint16_t UART_FlagStatus(UART_TypeDef *UARTx);
static inline uint16_t UART_FlagStatus(UART_TypeDef *UARTx)
{
  return UARTx->SR;
}
