...
* Return         : None.
*******************************************************************************/
extern void BSPI_Init( BSPI_TypeDef *BSPIx);
...
* Return         : None.
*******************************************************************************/
extern void BSPI_TrItSrc(BSPI_TypeDef *BSPIx, BSPI_TR_IT_SRCS TrItSrc);
...
* Return         : None.
*******************************************************************************/
extern void BSPI_RcItSrc(BSPI_TypeDef *BSPIx, BSPI_RC_IR_SRCS RcItSrc);
...
* Return         : None.
*******************************************************************************/
extern void BSPI_TrFifoDepth(BSPI_TypeDef *BSPIx, uint8_t TDepth);
...
* Return         : None.
*******************************************************************************/
extern void BSPI_RcFifoDepth(BSPI_TypeDef *BSPIx, uint8_t RDepth);
...
* Return         : None.
*******************************************************************************/
static inline void BSPI_ClockDividerConfig(BSPI_TypeDef *BSPIx, uint8_t Div);
static inline void BSPI_ClockDividerConfig(BSPI_TypeDef *BSPIx, uint8_t Div)
{
  BSPIx->CLK = Div;
}
...
* Return         : None.
*******************************************************************************/
static inline void BSPI_WordSend(BSPI_TypeDef *BSPIx, uint16_t Data);
static inline void BSPI_WordSend(BSPI_TypeDef *BSPIx, uint16_t Data)
{
...
* Input 1        : BSPIx where x can be 0 or 1 to select the BSPI peripheral.
* Input 2        : PtrToBuffer is an ‘uint8_t’ pointer to the first word of the buffer to be transmitted.
* Input 3        : NbOfWords parameter indicates the number of words saved in the buffer to be sent.
* Output         : None.
* Return         : None.
*******************************************************************************/
extern void BSPI_BufferSend(BSPI_TypeDef *BSPIx, uint8_t *PtrToBuffer, uint8_t NbOfWords);
...
*******************************************************************************/
static inline uint16_t BSPI_WordReceive(BSPI_TypeDef *BSPIx);
static inline uint16_t BSPI_WordReceive(BSPI_TypeDef *BSPIx)
{
...
* Input 1        : BSPIx where x can be 0 or 1 to select the BSPI peripheral.
* Input 2        : PtrToBuffer is an ‘uint8_t’ pointer to the first word of the defined area to save the received buffer.
* Input 3        : NbOfWords parameter indicates the number of words to be received in the buffer.
* Output         : None.
* Return         : None.
*******************************************************************************/
extern void BSPI_BufferReceive(BSPI_TypeDef *BSPIx, uint8_t *PtrToBuffer, uint8_t NbOfWords);
